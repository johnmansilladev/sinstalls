<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h3 class="content-header-title float-start mb-0">@yield('title')</h3>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    @foreach ($buttonOptions as $option)
                        <a class="dropdown-item"
                            {{ isset($option['url']) ? 'href='. route($option['url']).'' : '' }} 
                            {{ isset($option['nameModal']) ? 'data-bs-toggle="modal" data-bs-target="'. $option['nameModal'].'"' : '' }} >
